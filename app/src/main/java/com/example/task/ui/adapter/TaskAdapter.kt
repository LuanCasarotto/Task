...
class TaskAdapter(
    ...
    override fun onBindViewHolder(holder: TaskAdapter.MyViewHolder, position: Int) {
        ...
        holder.binding.tvDelete.setOnClickListener { taskSelected(task, SELECT_REMOVE) }
        holder.binding.tvEdit.setOnClickListener { taskSelected(task, SELECT_EDIT) }
        holder.binding.tvDetails.setOnClickListener { taskSelected(task, SELECT_DETAILS) }
